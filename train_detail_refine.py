        ...
        while train_data is not None:
            ...
            if rank == 0 and num_iter_accum % interval_print == 0:
                ...
                msg = (
                    ...
                    f"corr_loss: [{outputs['correction_loss'].item():.6f}], "
                    ...
                    f"pred_detail_abs: [{to_float(outputs['pred_detail_abs']):.6f}], "
                    f"target_detail_abs: [{to_float(outputs['target_detail_abs']):.6f}], "
                    f"corr_corr: [{to_float(outputs['correction_corr']):.4f}], "
